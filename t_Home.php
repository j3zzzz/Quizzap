...
<head>
    ...
    <style>
        * {
        ...
        .studs, .correct, .incorrect {
            position: relative;
            display: inline-block;
        }

        .studs .tooltiptext, .correct .tooltiptext, .incorrect .tooltiptext {
            font-family: 'Tilt Warp Regular';
            font-size: 12px;
            visibility: hidden;
            width: 180px;
        ...
        .studs .tooltiptext::after, .correct .tooltiptext:after, .incorrect .tooltiptext:after {
            content: "";
            position: absolute;
            top: 100%;
            left: 48%;
        ...
        .studs:hover .tooltiptext, .correct:hover .tooltiptext, .incorrect:hover .tooltiptext{
            visibility: visible;
            opacity: 1;
        }
            ...
            <div class="cards">
                ...
                <div class="success-quiz-card">
                    <i class="fa-solid fa-thumbs-up thumb"></i>
                        <h3>Quiz with the Most High Scores</h3>                         
                        <br>
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($quiz = $result->fetch_assoc()): ?>
                                    ...
                                    <div class="quiz-status">
                                        <div class="studs">
                                            <span class="tooltiptext">No. of students who took this quiz: <?php echo ($quiz['total_students']); ?></span>
                                                <i class="fa-solid fa-circle-user"></i>
                                        </div>    
                                        
                                        <div class="correct">
                                            <span class="tooltiptext">Correct Answers: <?php echo ($quiz['correct_answers']); ?></span>
                                            <i class="fa-solid fa-circle-check"></i>
                                        </div>

                                        <div class="incorrect">
                                            <span class="tooltiptext">Incorrect Answers: <?php echo ($quiz['incorrect_answers']); ?></span>
                                    ...
                                    <div id="sub">
                                        ...
                                        <a href="t_quizDash.php?subject_id=<?php echo $subject_id; ?>"><?php echo htmlspecialchars($quiz['subject_name']); ?></a>
                                    </div>
                            ...
                            <?php endwhile; ?>   
                        <?php else: ?>
                            <p style="color: #6666; text-align:center; margin-top: 5%; font-family: 'Tilt Warp Regular';">No challenging quizzes found.</p>
                        <?php endif; ?>   
                </div>
