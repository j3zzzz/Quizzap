    ...
    $sql = "SELECT question_id, question_text, question_type FROM questions WHERE quiz_id = $quiz_id LIMIT 10";
...
.matching-image {
    ...
    <div class="quiz-container">
        <div id="quiz-header">
            ...
            <div id="timer" class="timer">Time Remaining: <?php echo $quiz['timer']; ?></div>
        </div>
