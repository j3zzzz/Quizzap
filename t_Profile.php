...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password_change_attempted) {
        ...
        if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
            ...
            $password_sql = "SELECT password FROM teachers WHERE account_number = ?";
            ...
            if ($password_result->num_rows > 0) {
                ...
                if (password_verify($current_password, $hashed_password)) {
                    ...
                    $update_password_sql = "UPDATE teachers SET password = ? WHERE account_number = ?";
            ...
            <div class="profile-content">
                ...
                <form id="editMode" method="POST" enctype="multipart/form-data" class="profile-form hidden">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" value="<?php echo htmlspecialchars($school_id); ?>" disabled>
                    </div>
