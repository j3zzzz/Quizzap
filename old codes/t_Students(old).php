            ...
            if ($verify_result->num_rows == 0) {
                ...
                try {
                    while (($data = fgetcsv($handle)) !== FALSE) {
                        ...
                        // Prepare SQL for inserting/updating student
                        ...
                        fname = VALUES(fname), 
                        lname = VALUES(lname), 
                        glevel = VALUES(glevel), 
                        strand = COALESCE(VALUES(strand), strand)";

                        $student_stmt = $conn->prepare($student_sql);
                    
                        // Generate a default password
                        $default_password = password_hash($account_number, PASSWORD_DEFAULT);
                        ...
                        if ($student_stmt->execute()) {
                            ...
                            if ($enrollment_stmt->execute()) {
                                if ($student_stmt->affected_rows == 1) {
                                    $imported_count++;
                                } elseif ($student_stmt->affected_rows == 2) {
                                    $updated_count++;
                                }
                            }
                    ...
                    $_SESSION['import_message'] = "Import successful. 
                        Total students in $subject_name: $total_students.";
        ...
        <div class="content">
           ...
           <table>
            ...
            <?php } 
                if ($result->num_rows === 0) { ?>
                <tr>
                    <td colspan="7">You don't have any students yet.</td> 
                </tr>
            <?php } ?>
            </table> 
            <br><br>
